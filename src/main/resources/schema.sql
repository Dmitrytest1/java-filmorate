...
CREATE TABLE IF NOT EXISTS LIKES (
    UserID int NOT NULL,
    FilmID int NOT NULL,
    CONSTRAINT pk_Like PRIMARY KEY (UserID, FilmID)
);
...
CREATE TABLE IF NOT EXISTS MPA (
    ...
    CONSTRAINT pk_Mpa PRIMARY KEY (MpaID),
...
ALTER TABLE FILM ADD CONSTRAINT IF NOT EXISTS fk_Film_MpaID FOREIGN KEY (MpaID)
    REFERENCES MPA (MpaID) ON DELETE RESTRICT;
